...
void main() {
  ...
  vec3 localLightPosition = lightPosition;
  localLightPosition.x -= 3.0;
  localLightPosition.y -= 1.0;
  float lightPos = dot(normalize(localLightPosition), normalize(vNormal));
  lightPos = abs(lightPos * 0.8 + 0.2);
